...
operation::커버 영상 업로드[snippets='http-request,request-parts,http-response']

[[upload-highlight-cover]]
=== 커버 하이라이트 업로드

커버 하이라이트 영상을 업로드할 수 있다.

operation::커버 하이라이트 영상 업로드[snippets='http-request,request-parts,http-response']

[[upload-thumbnail-cover]]
=== 커버 썸네일 이미지 업로드

커버 썸네일 이미지를 업로드할 수 있다.

operation::커버 썸네일 이미지 업로드[snippets='http-request,request-parts,http-response']
